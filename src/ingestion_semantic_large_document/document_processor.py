"""Enhanced semantic document processor for large documents using LangChain."""
...
class EnhancedSemanticDocumentProcessor:
    """
    Enhanced semantic document processor for large documents that orchestrates the entire pipeline.

    Uses LangChain for document loading and integrates enhanced features for large documents:
    - Enhanced contextual retrieval with document structure analysis
    - Section-based contextualization for better chunk semantics
    ...
    - Document structure preservation and analysis
    """
    ...
    def __init__(self, config):
        ...
        self.contextual_retrieval = EnhancedContextualRetrieval(config)
        self.semantic_chunker = EnhancedSemanticChunker(
            config, self.contextual_retrieval
        )
