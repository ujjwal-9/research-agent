"""Configuration management for the semantic ingestion pipeline."""
...
class SemanticIngestionConfig:
    ...
    def _setup_logging(self) -> logging.Logger:
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler(
                    f"logs/semantic_ingestion_{self._get_timestamp()}.log"
                ),
    ...
    def qdrant_collection_name(self) -> str:
        """Get Qdrant collection name for semantic ingestion."""
        return os.getenv("QDRANT_SEMANTIC_COLLECTION_NAME", "semantic_redesign")
